      ...
      <form id="enroll-form" class="p-6 md:p-10 space-y-6" onsubmit="submitForm(event)">
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6">
          ...
          <div class="space-y-1">
            ...
            <input id="input-cedula" required type="text" pattern="[0-9]{10}" maxlength="10" oninput="this.value = this.value.replace(/[^0-9]/g, '')" class="w-full px-4 py-2 border border-gray-100 rounded-lg bg-white focus:ring-2 focus:ring-[#00A3E0] outline-none text-gray-700 shadow-sm" placeholder="10 dígitos" />
          </div>
        </div>
